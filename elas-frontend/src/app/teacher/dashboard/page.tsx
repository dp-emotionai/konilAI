...
function toPreparationSession(session: TeacherDashboardSession) {
  return {
    id: session.id,
    title: session.title,
    status:
...
export default function TeacherDashboard() {
  ...
  const [selectedSession, setSelectedSession] = useState<TeacherDashboardSession | null>(null);
  ...
  return (
      <div className="min-h-[calc(100vh-64px)] bg-[#FAFAFB] pb-16 pt-8 md:pt-12">
        ...
        <TeacherSessionPreparationModal
            ...
            session={selectedSession ? toPreparationSession(selectedSession) : null}
