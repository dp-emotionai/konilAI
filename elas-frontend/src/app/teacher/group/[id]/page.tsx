  ...
  useEffect(() => {
    ...
    fetch(groupImageUrl, {
      ...
      signal: controller.signal,
        ...
        .then((response) => {
          if (!response.ok) throw new Error("Failed to load group image");
        ...
        <Section spacing="none">
          ...
          >
            <div
                ...
                style={
                  displayGroupImageUrl
                      ? {
                        backgroundImage: `linear-gradient(90deg, rgba(255,255,255,.82), rgba(255,255,255,.66)), url(${displayGroupImageUrl})`,
                  ...
                  {displayGroupImageUrl ? (
                      <div className="relative group/avatar">
                        <div
                            ...
                            style={{ backgroundImage: `url(${displayGroupImageUrl})` }}
                        />
                        <button
                            type="button"
