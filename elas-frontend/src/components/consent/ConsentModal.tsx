        ...
        >
          ...
          <div className="relative max-h-[calc(100vh-32px)] overflow-y-auto px-5 pb-5 pt-5 sm:px-10 sm:pb-7 sm:pt-8">
            <button
              ...
              aria-label="Закрыть"
              onClick={onClose}
              className="absolute right-4 top-4 grid h-10 w-10 place-items-center rounded-xl bg-violet-50 text-slate-700 transition hover:bg-violet-100 hover:text-slate-950 sm:right-6 sm:top-6"
            >
              <X size={21} />
            </button>

            <div className="pr-12">
              <div className="text-sm font-semibold text-[#7448FF]">Согласие</div>
              <h1
            ...
            <div className="mt-6 space-y-2.5">
              {consentItems.map(({ title, description, icon: Icon }) => (
                <div
                  key={title}
            ...
            <div className="mt-3.5 flex gap-3 rounded-[18px] border border-violet-100 bg-violet-50/75 px-4 py-3.5 sm:px-5">
              ...
              <div>
                ...
                <div className="mt-0.5 text-xs font-medium leading-relaxed text-slate-500 sm:text-[13px]">
                  Данные используются только для улучшения образовательного процесса и строго в соответствии с принципами этики и конфиденциальности.
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 flex flex-col gap-3">
              <Button
                onClick={onAccept}
                className="h-12 w-full rounded-[14px] border-none bg-[#7448FF] text-base font-semibold text-white shadow-[0_14px_30px_rgba(116,72,255,0.28)] hover:bg-[#6538f5]"
              >
              ...
              <Link
                href="/privacy"
                className="inline-flex h-12 w-full items-center justify-center rounded-[14px] border border-[#7448FF] bg-white px-5 text-base font-semibold text-[#7448FF] shadow-sm transition hover:bg-violet-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7448FF]/50 focus-visible:ring-offset-2"
              >
              ...
              <Link
                href="/ethics"
                className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-[14px] border border-violet-200 bg-white px-5 text-base font-semibold text-[#7448FF] shadow-sm transition hover:bg-violet-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7448FF]/50 focus-visible:ring-offset-2"
              >
                <ShieldCheck size={18} />
              ...
              {onContinueWithoutAnalysis && (
                <button
                  ...
                  className="mx-auto px-4 py-1 text-sm font-semibold text-[#7448FF] transition hover:text-[#5f31e8] hover:underline"
                >
